...
class EntitySurfaceType(Enum):
    ...
    FLOWER = Animation(FLOWER_SS, 0, 0, 32, 32, 2, frame_interval_by_sec=4)
...
class Player:
    def __init__(self):
        self.x = CAMERA_CENTER_X
        self.y = CAMERA_CENTER_Y
        self.next_x = CAMERA_CENTER_X
        self.next_y = CAMERA_CENTER_Y
